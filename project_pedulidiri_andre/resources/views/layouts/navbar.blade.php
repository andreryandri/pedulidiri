<nav class="navbar navbar-header navbar-expand navbar-light" style="background-image: url('../assets/img/pattern7.png')">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">  
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="">
                <button type="button" class="btn  border block" data-bs-toggle="modal" data-bs-target="#border-less">
                    <i data-feather="grid">Filter</i>
                </button>
            ...
            <li class="dropdown">
                <a href="#" data-bs-toggle="dropdown"
                    ...
                    <div class="avatar me-1">
                        <img src="../assets/img/avatar/avatarl.png" alt="" srcset="">
                    </div>
