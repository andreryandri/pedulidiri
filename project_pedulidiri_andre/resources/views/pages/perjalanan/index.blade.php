            ...
            <div class="card-body px-0 py-1">
                ...
                <table class='table table-borderless'>
                    ...
                    <tr>
                        ...
                        <td class='col-8'>
                            <input type="number" onkeypress="return event.charCode>=48 && event.charCode<=57" min="34" max="39" class="form-control" name="suhu" value="{{ $data->suhu }}" onchange="checkUpdatedData(this)">
                        </td>
                    </tr>
                    <tr>
                        <td class='col-3'>Tanggal</td>
                        <td class='col-8'>
                            <input type="date" id="datePickerId" class="form-control" name="tanggal" value="{{ $data->tanggal }}" onchange="checkUpdatedData(this)">
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="col-sm-12 d-flex justify-content-end px-4 py-2">
                    <button type="submit" class="btn btn-dark me-1 mb-1" id="btnUpdateData">Simpan</button>
                </div>
                </form>
            </div>
        </div>
